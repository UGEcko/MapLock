...
if (!ref) {
    const latestRelease = await fetch("https://api.github.com/repos/Splashcard04/MapLock/releases/latest", {
        headers: {
...
// now copy to path
const ignoredFiles = ["setup", ".git", "README.md", ".gitignore", "Examples", "test", "LICENSE"]
...
console.log(`Yay we did the setup for EnvMods at ${destFolder}`)
